        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, null, "~/images/noses/nose_1.svg" },
                    { 3, 3, null, "~/images/mouths/mouth_1.svg" },
                    { 4, 4, null, "~/images/eyes/eye_1.svg" },
                    { 5, 1, null, "~/images/bodies/body_2.svg" },
                    { 6, 2, null, "~/images/noses/nose_2.svg" },
                    { 7, 3, null, "~/images/mouths/mouth_2.svg" },
                    { 8, 4, null, "~/images/eyes/eye_2.svg" },
                    { 9, 1, null, "~/images/bodies/body_3.svg" },
                    { 10, 2, null, "~/images/noses/nose_3.svg" },
                    { 11, 3, null, "~/images/mouths/mouth_3.svg" },
